    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          {filteredHistory.length === 0 ? (
            ...
            filteredHistory.map((item) => (
              <div key={item.id} className="border-b border-slate-100">
                <div onClick={() => toggleExpand(item.id)} className={`p-4 ${expandedId === item.id ? 'bg-blue-50/30' : ''}`}>
                  <div className="flex justify-between items-center">
                    <div>
                      <div className="font-bold text-slate-700">{item.name}</div>
                      <div className="text-[10px] text-slate-400 uppercase font-black tracking-widest">
      ...
      <div className="mt-10">
        <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="font-black text-xl uppercase tracking-tighter">Printed Parts Inventory</h2>
        </div>
        <div className="grid grid-cols-1 gap-4">
